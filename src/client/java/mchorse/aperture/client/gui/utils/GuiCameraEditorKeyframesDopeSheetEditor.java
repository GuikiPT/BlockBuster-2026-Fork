...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/utils/GuiCameraEditorKeyframesDopeSheetEditor.java
 */
public class GuiCameraEditorKeyframesDopeSheetEditor extends GuiCameraEditorKeyframesEditor<GuiDopeSheet>
{
    public GuiCameraEditorKeyframesDopeSheetEditor(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
