...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/utils/GuiGraphView.java
 */
public class GuiGraphView extends mchorse.mclib.client.gui.framework.elements.keyframes.GuiGraphView
{
    ...
    public GuiGraphView(MinecraftClient mc, GuiCameraEditorKeyframesGraphEditor keyframeEditor, Consumer<Keyframe> callback)
    {
        super(mc, callback);
    ...
    protected void drawCursor(GuiContext context)
    {
        if (this.editor != null)
        {
            ...
            {
                GuiDraw.drawRect(cx - 1, cy, cx + 1, this.area.ey(), 0xff57f52a);
            }
        }
    }
}
