...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/utils/GuiDopeSheet.java
 */
public class GuiDopeSheet extends mchorse.mclib.client.gui.framework.elements.keyframes.GuiDopeSheet
{
    ...
    public GuiDopeSheet(MinecraftClient mc, GuiCameraEditorKeyframesDopeSheetEditor keyframeEditor, Consumer<Keyframe> callback)
    {
        super(mc, callback);
    ...
    protected void drawCursor(GuiContext context)
    {
        if (this.editor != null)
        {
            ...
            GuiDraw.drawRect(cx - 1, this.area.y, cx + 1, this.area.ey(), 0xff57f52a);
        }
    }
}
