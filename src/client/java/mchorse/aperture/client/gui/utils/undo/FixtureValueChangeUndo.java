...
/**
 * Fixture value change undo (P183) — addresses a property in the camera
 * profile's values tree by its dotted path (e.g. "fixtures.3.duration");
 * consecutive changes to the same property of the same fixture merge.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/utils/undo/FixtureValueChangeUndo.java
 */
