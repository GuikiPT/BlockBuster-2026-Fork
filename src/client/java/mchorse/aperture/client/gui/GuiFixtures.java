 ...
 * Fed by the client fixture registry — registration order defines the
 * button order (and the Ctrl+number keybind ids).
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/GuiFixtures.java
 */
public class GuiFixtures extends GuiElement
{
    public Consumer<AbstractFixture> callback;

    public GuiFixtures(MinecraftClient mc, Consumer<AbstractFixture> callback)
    {
        super(mc);
