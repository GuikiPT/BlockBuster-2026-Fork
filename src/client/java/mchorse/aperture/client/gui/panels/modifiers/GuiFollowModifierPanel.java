...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiFollowModifierPanel.java
 */
public class GuiFollowModifierPanel extends GuiAbstractModifierPanel<FollowModifier>
{
    ...
    public GuiFollowModifierPanel(MinecraftClient mc, FollowModifier modifier, GuiModifiersManager modifiers)
    {
