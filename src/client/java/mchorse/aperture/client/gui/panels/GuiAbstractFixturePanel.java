...
/**
 * Base class for abstract fixture panel (P184 — full legacy widget roster)
 *
 * This panel adds inputs for only two properties (which has every camera
 * fixture): name and duration.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/GuiAbstractFixturePanel.java
 */
public abstract class GuiAbstractFixturePanel<T extends AbstractFixture> extends GuiElement implements IFixturePanel<T>
{
    ...
    public GuiAbstractFixturePanel(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc);
