 ...
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modules/GuiAngleModule.java
 */
public class GuiAngleModule extends GuiAbstractModule
{
    ...
    public GuiAngleModule(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
