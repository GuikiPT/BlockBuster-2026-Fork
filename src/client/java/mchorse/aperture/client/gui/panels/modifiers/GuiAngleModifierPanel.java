...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiAngleModifierPanel.java
 */
public class GuiAngleModifierPanel extends GuiAbstractModifierPanel<AngleModifier>
{
    ...
    public GuiAngleModifierPanel(MinecraftClient mc, AngleModifier modifier, GuiModifiersManager modifiers)
    {
