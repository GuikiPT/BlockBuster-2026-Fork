...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiDollyZoomModifierPanel.java
 */
public class GuiDollyZoomModifierPanel extends GuiAbstractModifierPanel<DollyZoomModifier>
{
    public GuiTrackpadElement focus;

    public GuiDollyZoomModifierPanel(MinecraftClient mc, DollyZoomModifier modifier, GuiModifiersManager panel)
    {
