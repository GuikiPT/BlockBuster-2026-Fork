...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiRemapperModifierPanel.java
 */
public class GuiRemapperModifierPanel extends GuiAbstractModifierPanel<RemapperModifier>
{
    ...
    public GuiRemapperModifierPanel(MinecraftClient mc, RemapperModifier modifier, GuiModifiersManager modifiers)
    {
