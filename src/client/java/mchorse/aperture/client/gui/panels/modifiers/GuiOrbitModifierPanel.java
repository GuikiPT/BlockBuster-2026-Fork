...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiOrbitModifierPanel.java
 */
public class GuiOrbitModifierPanel extends GuiAbstractModifierPanel<OrbitModifier>
{
    ...
    public GuiOrbitModifierPanel(MinecraftClient mc, OrbitModifier modifier, GuiModifiersManager modifiers)
    {
