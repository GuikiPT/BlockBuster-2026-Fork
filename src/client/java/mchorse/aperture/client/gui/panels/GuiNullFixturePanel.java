...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/GuiNullFixturePanel.java
 */
public class GuiNullFixturePanel extends GuiAbstractFixturePanel<NullFixture>
{
    public GuiToggleElement previous;

    public GuiNullFixturePanel(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
        ...
        this.keys().register(IKey.lang("aperture.gui.panels.keys.previous"), LegacyKeyCodes.KEY_P, () -> this.previous.clickItself(GuiBase.getCurrent())).held(LegacyKeyCodes.KEY_LCONTROL).active(editor::isFlightDisabled).category(CATEGORY);
    }
