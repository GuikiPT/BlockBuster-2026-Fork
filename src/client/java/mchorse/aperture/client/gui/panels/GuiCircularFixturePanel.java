 ...
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/GuiCircularFixturePanel.java
 */
public class GuiCircularFixturePanel extends GuiAbstractFixturePanel<CircularFixture>
{
    ...
    public GuiCircularFixturePanel(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
