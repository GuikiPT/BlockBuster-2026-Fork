...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiDragModifierPanel.java
 */
public class GuiDragModifierPanel extends GuiAbstractModifierPanel<DragModifier>
{
    ...
    public GuiDragModifierPanel(MinecraftClient mc, DragModifier modifier, GuiModifiersManager modifiers)
    {
