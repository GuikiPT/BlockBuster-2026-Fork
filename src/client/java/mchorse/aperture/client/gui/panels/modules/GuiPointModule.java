 ...
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modules/GuiPointModule.java
 */
public class GuiPointModule extends GuiAbstractModule
{
    ...
    public GuiPointModule(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
