...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiTranslateModifierPanel.java
 */
public class GuiTranslateModifierPanel extends GuiAbstractModifierPanel<TranslateModifier>
{
    ...
    public GuiTranslateModifierPanel(MinecraftClient mc, TranslateModifier modifier, GuiModifiersManager modifiers)
    {
