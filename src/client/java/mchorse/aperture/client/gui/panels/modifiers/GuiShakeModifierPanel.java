...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiShakeModifierPanel.java
 */
public class GuiShakeModifierPanel extends GuiAbstractModifierPanel<ShakeModifier>
{
    ...
    public GuiShakeModifierPanel(MinecraftClient mc, ShakeModifier modifier, GuiModifiersManager panel)
    {
