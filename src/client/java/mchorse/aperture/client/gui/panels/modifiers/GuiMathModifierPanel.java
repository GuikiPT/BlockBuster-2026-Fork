...
/**
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modifiers/GuiMathModifierPanel.java
 */
public class GuiMathModifierPanel extends GuiAbstractModifierPanel<MathModifier>
{
    ...
    public GuiMathModifierPanel(MinecraftClient mc, MathModifier modifier, GuiModifiersManager modifiers)
    {
