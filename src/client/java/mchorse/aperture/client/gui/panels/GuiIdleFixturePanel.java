 ...
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/GuiIdleFixturePanel.java
 */
public class GuiIdleFixturePanel extends GuiAbstractFixturePanel<IdleFixture>
{
    ...
    public GuiIdleFixturePanel(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
