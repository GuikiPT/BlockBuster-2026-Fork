 ...
 * in other classes.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/client/gui/panels/modules/GuiCircularModule.java
 */
public class GuiCircularModule extends GuiAbstractModule
{
    ...
    public GuiCircularModule(MinecraftClient mc, GuiCameraEditor editor)
    {
        super(mc, editor);
