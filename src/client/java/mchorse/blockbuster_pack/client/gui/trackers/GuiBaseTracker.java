...
/**
 * Base tracker editor sub-panel (port of Blockbuster 2.7.2's
 * {@code GuiBaseTracker}, roadmap P166). Edits the shared {@link
 * BaseTracker#name} label; subclasses append tracker-specific fields.
 *
 * Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster_pack/client/gui/trackers/GuiBaseTracker.java
 */
public class GuiBaseTracker<T extends BaseTracker> extends GuiElement
{
    ...
    public GuiBaseTracker(MinecraftClient mc)
    {
        super(mc);
