...
/**
 * Port of McLib 2.4.3's {@code GridResizer} (roadmap P30). The fixed cell
 * width mode ({@link #width(int)}) needs two resize passes — a known legacy
 * TODO kept as-is (dashboards call {@code resize()} once; the visual state
 * after one pass is the spec).
 */
public class GridResizer extends AutomaticResizer
{
     ...
     *
     * TODO: maybe fix it? (legacy TODO, kept — behavior after one pass is
     * the spec)
     */
