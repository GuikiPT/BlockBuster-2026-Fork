 ...
 * {@link GuiElement}.
 *
 * Port of McLib 2.4.3's {@code Flex} (roadmap P30) — pure math, ported
 * verbatim. Note the post-resizer is consulted for W/H only when it reports a
 * nonzero value (column layouts rely on this).
 */
