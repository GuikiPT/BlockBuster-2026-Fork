 ...
 *
 * (Port of McLib 2.4.3's {@code Scale} — roadmap P30/P43. Pure math,
 * ported verbatim; deferred from P30 to P43 because the keyframe editors
 * are its first consumer. The stepped zoom factor table and the hardcoded
 * grid-multiplier caps are 1.12.2 behavior contracts.)
 */
public class Scale
{
