...
/**
 * Port of McLib 2.4.3's {@code Icons} (roadmap P31). The 256×256 atlas UVs
 * are a wire/disk-like contract for addons (Mappet-style UI API via
 * {@link IconRegistry}) — pinned by a reflection test; do not shift.
 * Texture asset: {@code assets/mclib/textures/gui/icons.png} (byte-identical
 * copy of the legacy atlas; the bundled dep keeps its asset namespace).
 */
public class Icons
{
    /**
