...
/**
 * Port of McLib 2.4.3's {@code RowResizer} (roadmap P30).
 */
public class RowResizer extends AutomaticResizer
{
    ...
    /**
     * Legacy bug (load-bearing, pinned by test): this assigns the loop-counter
     * field {@code i}, NOT the {@code index} parameter — the argument is
     * effectively ignored. Reproduced verbatim from 1.12.2 (line 55 of the
     * legacy source); do not "fix".
     */
