 ...
 * directional objects.
 *
 * Port of McLib 2.4.3's {@code ScrollArea} (roadmap P30). {@code Gui.drawRect}
 * maps to {@link GuiDraw#drawRect}. The {@code getIndex} sentinels are API:
 * {@code -1} above the list, {@code -2} past the end (drag-reorder in P35
 * maps {@code -2} to "last").
 */
