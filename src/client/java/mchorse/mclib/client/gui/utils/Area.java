 ...
 *
 * Port of McLib 2.4.3's {@code Area} (roadmap P30). 1.12.2's static
 * {@code Gui.drawRect} in {@link #draw} maps to {@link GuiDraw#drawRect}.
 */
public class Area implements IResizer
{
    ...
    /**
     * Legacy quirk (load-bearing): the offset is added to {@code w}/{@code h}
     * only once (not twice), while being subtracted from {@code x}/{@code y} —
     * kept verbatim from 1.12.2.
     */
