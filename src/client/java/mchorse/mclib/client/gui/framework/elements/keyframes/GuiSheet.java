...
/**
 * Port of McLib 2.4.3's {@code GuiSheet} (roadmap P43) — one keyframe
 * channel row of a dope sheet / graph view, carrying the selection index
 * list. The sheet {@link #id} is the key of the cross-editor clipboard NBT
 * format (shared with Aperture's editors, S15) — a wire contract.
 *
 * <p>Ported verbatim; note {@code duplicate}'s {@code minTick} starting at
 * {@code Integer.MAX_VALUE} (not Long) is a legacy quirk kept as-is.</p>
 */
