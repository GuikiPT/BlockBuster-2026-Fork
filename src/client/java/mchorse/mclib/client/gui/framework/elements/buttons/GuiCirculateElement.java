...
/**
 * Port of McLib 2.4.3's {@code GuiCirculateElement} (roadmap P32).
 * Left-click cycles forward, right-click backward; disabled values are
 * skipped recursively in the travel direction (wrap terminates because
 * {@code disable()} refuses to disable every value). Hover label color
 * 16777120 (yellow) is a visual contract.
 */
public class GuiCirculateElement extends GuiClickElement<GuiCirculateElement>
{
    ...
    public GuiCirculateElement(MinecraftClient mc, Consumer<GuiCirculateElement> callback)
    {
        super(mc, callback);
    ...
    protected void drawSkin(GuiContext context)
    {
        ...
        GuiDraw.drawStringWithShadow(this.font, label, x, y, this.hover ? 16777120 : 0xffffff);
