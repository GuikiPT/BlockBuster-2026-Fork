 ...
 * itself is not editing the color, the picker element is the one that does
 * color editing.
 *
 * (Port of McLib 2.4.3's {@code GuiColorElement}, roadmap P34.)
 */
public class GuiColorElement extends GuiElement
{
    ...
    public GuiColorElement(MinecraftClient mc, ValueInt value)
    {
        this(mc, value, null);
    }

    public GuiColorElement(MinecraftClient mc, ValueInt value, Consumer<Integer> callback)
    {
    ...
    public GuiColorElement(MinecraftClient mc, Consumer<Integer> callback)
    {
        super(mc);
    ...
    public void draw(GuiContext context)
    {
        ...
        if (this.label)
        {
            ...
            GuiDraw.drawTextBackground(this.font, label, this.area.mx(GuiDraw.textWidth(this.font, label)), this.area.my(GuiDraw.fontHeight(this.font) - 1), 0xffffff, 0x55000000, 1);
        }
