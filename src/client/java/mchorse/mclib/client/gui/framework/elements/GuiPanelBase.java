 ...
 *
 * (Port of McLib 2.4.3's {@code GuiPanelBase}, roadmap P37. Tab buttons
 * chain relative to the previous button — registration order defines the
 * strip order, which S12 panels rely on.)
 */
public class GuiPanelBase<T extends GuiElement> extends GuiElement
{
    ...
    public GuiPanelBase(MinecraftClient mc)
    {
        this(mc, Direction.BOTTOM);
    }

    public GuiPanelBase(MinecraftClient mc, Direction direction)
    {
        super(mc);
