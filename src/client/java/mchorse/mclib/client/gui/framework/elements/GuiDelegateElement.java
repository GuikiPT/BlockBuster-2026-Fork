 ...
 *
 * Port of McLib 2.4.3's {@code GuiDelegateElement} (roadmap P29/P37). Ported
 * with the core (rather than P37) because {@link GuiElement#canBeSeen()}
 * special-cases it: a child of a delegate that is not the current
 * {@code delegate} is treated as invisible.
 */
public class GuiDelegateElement<T extends GuiElement> extends GuiElement
{
    public T delegate;

    public GuiDelegateElement(MinecraftClient mc, T element)
    {
        super(mc);
