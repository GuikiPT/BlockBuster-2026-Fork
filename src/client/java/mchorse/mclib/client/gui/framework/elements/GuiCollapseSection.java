...
/**
 * Port of McLib 2.4.3's {@code GuiCollapseSection} (roadmap P37).
 * Toggling triggers a resize from the ROOT element (fields shift everything
 * below) — kept verbatim.
 */
public class GuiCollapseSection extends GuiElement
{
     ...
     */
    public GuiCollapseSection(MinecraftClient mc, IKey title, Supplier<Integer> titleBackground, boolean collapsed)
    {
        super(mc);
    ...
    public GuiCollapseSection(MinecraftClient mc, IKey title, Supplier<Integer> titleBackground)
    {
        this(mc, title, titleBackground, false);
    }

    public GuiCollapseSection(MinecraftClient mc, IKey title)
    {
