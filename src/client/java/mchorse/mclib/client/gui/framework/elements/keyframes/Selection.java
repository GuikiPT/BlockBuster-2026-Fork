...
/**
 * Port of McLib 2.4.3's keyframe editor {@code Selection} enum (roadmap
 * P43). The bezier handle mirroring rules are encoded in the
 * {@code opposite} flag: X mirrors as-is, Y mirrors negated
 * ({@code ly → -ry} / {@code ry → -ly}) — a 1.12.2 behavior contract.
 */
