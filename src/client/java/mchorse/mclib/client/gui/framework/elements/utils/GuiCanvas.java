...
/**
 * Port of McLib 2.4.3's {@code GuiCanvas} (roadmap P45) — the 2D pan/zoom
 * canvas base (multiskin editor P40, Snowstorm texture editing S13).
 *
 * <p>Pure {@link Scale} math; the only 1.20.4 mapping is legacy
 * {@code Minecraft.IS_RUNNING_ON_MAC} → {@code MinecraftClient.IS_SYSTEM_MAC}
 * (the legacy Mac scroll-inversion quirk in {@link #mouseScrolled} is
 * preserved: on non-Mac the wheel value is negated before zooming).</p>
 */
public class GuiCanvas extends GuiElement
{
    ...
    public GuiCanvas(MinecraftClient mc)
    {
        super(mc);
