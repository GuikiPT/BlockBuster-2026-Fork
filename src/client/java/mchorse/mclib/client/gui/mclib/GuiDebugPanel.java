...
/**
 * Port of McLib 2.4.3's {@code GuiDebugPanel} (roadmap P44) — the built-in
 * framework playground (dope sheet + graph view + assorted widgets). Only
 * registered when {@code McLib.debugPanel} is true.
 */
public class GuiDebugPanel extends GuiDashboardPanel<GuiAbstractDashboard>
{
    ...
    public GuiDebugPanel(MinecraftClient mc, GuiAbstractDashboard dashboard)
    {
        super(mc, dashboard);
        ...
        {
            @Override
            protected GuiDopeSheet createElement(MinecraftClient mc)
            {
