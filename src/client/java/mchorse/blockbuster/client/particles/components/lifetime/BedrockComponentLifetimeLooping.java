...
/**
 * {@code minecraft:emitter_lifetime_looping} — roadmap P150.
 *
 * <p>Stops the emitter after the active time, then restarts it once the age
 * reaches {@code sleep_time}. Each {@code stop()} rerolls the emitter randoms
 * (see P149), a visible authoring feature for looping effects.</p>
 */
