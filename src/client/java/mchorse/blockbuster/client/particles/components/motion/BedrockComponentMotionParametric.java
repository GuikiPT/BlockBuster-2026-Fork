...
/**
 * {@code minecraft:particle_motion_parametric} (roadmap P151).
 *
 * <p>Keys {@code relative_position} {@code [x,y,z]} and {@code rotation}. Drives
 * the particle position directly through {@code particle.matrix} relative to
 * {@code initialPosition} each tick and sets {@code particle.manual = true},
 * which <b>disables the whole physics integrator</b> (and exempts the particle
 * from collision response, offset/inertia logic, etc.). Runs both as a particle
 * initializer and updater at sorting index {@code 10}.</p>
 */
