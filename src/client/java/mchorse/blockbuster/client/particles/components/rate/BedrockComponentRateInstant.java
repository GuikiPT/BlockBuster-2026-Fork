...
/**
 * {@code minecraft:emitter_rate_instant} — roadmap P150.
 *
 * <p>Spawns all {@code num_particles} at once during the emitter update where
 * the emitter age epsilon-equals {@code 0} (seconds) while playing. Default
 * count is the constant {@code 10}, omitted from JSON when unchanged.</p>
 */
