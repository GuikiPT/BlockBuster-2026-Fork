...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormCollisionAppearanceSection}
 * (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormCollisionAppearanceSection.java</p>
 *
 * <p><b>Parity quirk (off-by-one):</b> {@code facingMode} has only 10 labels
 * indexing the 11-entry {@code SORTED_FACING_MODES} — labels after {@code lookat_y}
 * are shifted (rotate_xyz label selects LOOKAT_DIRECTION etc.) and
 * {@code EMITTER_YZ} is unreachable — preserved verbatim for GUI parity.</p>
 */
public class GuiSnowstormCollisionAppearanceSection extends GuiSnowstormComponentSection<BedrockComponentCollisionAppearance>
{
    ...
    public GuiSnowstormCollisionAppearanceSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
    ...
    /**
     * The collision-texture twin of
     * {@code GuiSnowstormGeneralSection.setTextureSize} — see its javadoc for
     * why the identifier goes through {@link GifTexture#resolveFrame} (P252)
     * rather than straight to {@code toIdentifier()}.
     */
