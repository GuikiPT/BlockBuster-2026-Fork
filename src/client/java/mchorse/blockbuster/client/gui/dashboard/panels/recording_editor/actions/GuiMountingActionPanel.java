...
/**
 * P139 — a single {@code mounting} toggle bound to
 * {@link MountingAction#isMounting}.
 */
public class GuiMountingActionPanel extends GuiActionPanel<MountingAction>
{
    public GuiToggleElement mounting;

    public GuiMountingActionPanel(MinecraftClient mc, GuiRecordingEditorPanel panel)
    {
        super(mc, panel);
