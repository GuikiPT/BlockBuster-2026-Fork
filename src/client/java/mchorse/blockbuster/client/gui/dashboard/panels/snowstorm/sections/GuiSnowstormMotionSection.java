...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormMotionSection} (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormMotionSection.java</p>
 *
 * <p>Also edits {@code BedrockComponentInitialSpeed} + {@code InitialSpin}; the
 * position x/y/z fields are dual-purpose (acceleration vs absolute position) with
 * swapped tooltips and a rebuilt title label; drag rows only exist in dynamic mode.</p>
 */
public class GuiSnowstormMotionSection extends GuiSnowstormModeSection<BedrockComponentMotion>
{
    ...
    public GuiSnowstormMotionSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
