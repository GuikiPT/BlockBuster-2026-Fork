...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormLightingSection} (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormLightingSection.java</p>
 *
 * <p><b>Parity quirks:</b> gradient range within 1e-10 of zero is silently
 * coerced to 1 (divide-by-zero guard); g/b/a parse errors recolor field
 * {@code r} ({@code this.r} passed to {@link #parse} for all four channels); the
 * "Lighting" checkbox writes no field — {@link #beforeSave} adds/removes the
 * whole {@code BedrockComponentAppearanceLighting} component. All preserved.</p>
 */
public class GuiSnowstormLightingSection extends GuiSnowstormSection
{
    ...
    public GuiSnowstormLightingSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
