...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormInitializationSection}
 * (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormInitializationSection.java</p>
 */
public class GuiSnowstormInitializationSection extends GuiSnowstormComponentSection<BedrockComponentInitialization>
{
    ...
    public GuiSnowstormInitializationSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
