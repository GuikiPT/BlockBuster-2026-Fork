...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormSpaceSection} (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormSpaceSection.java</p>
 *
 * <p><b>Parity quirk:</b> {@link #updateButtons()} body is deliberately commented
 * out in legacy, so {@code scaleBillboard} always shows regardless of the
 * {@code scale} toggle — preserved verbatim.</p>
 */
public class GuiSnowstormSpaceSection extends GuiSnowstormComponentSection<BedrockComponentLocalSpace>
{
    ...
    public GuiSnowstormSpaceSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
