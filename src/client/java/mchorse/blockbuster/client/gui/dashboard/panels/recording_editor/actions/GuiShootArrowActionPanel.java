...
/**
 * P139 — an integer {@code charge} trackpad (0..100) bound to
 * {@link ShootArrowAction#charge}.
 */
public class GuiShootArrowActionPanel extends GuiActionPanel<ShootArrowAction>
{
    public GuiTrackpadElement charge;

    public GuiShootArrowActionPanel(MinecraftClient mc, GuiRecordingEditorPanel panel)
    {
        super(mc, panel);
