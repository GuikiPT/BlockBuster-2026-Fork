...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormShapeSection} (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormShapeSection.java</p>
 *
 * <p>Nested {@link GuiDirectionSection} circulates outwards / inwards / custom
 * vector; the mode is detected by <b>identity</b> comparison against
 * {@link ShapeDirection#OUTWARDS}/{@link ShapeDirection#INWARDS} singletons.</p>
 */
public class GuiSnowstormShapeSection extends GuiSnowstormModeSection<BedrockComponentShapeBase>
{
    ...
    public GuiSnowstormShapeSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
    ...
    public static class GuiDirectionSection extends GuiElement
    {
        ...
        public GuiDirectionSection(MinecraftClient mc, GuiSnowstormShapeSection parent)
        {
            super(mc);
