...
/**
 * P139 — generic editor for {@link InteractBlockAction} and its subclasses:
 * three integer trackpads editing {@code action.pos} component-wise, rebuilding
 * the immutable {@link BlockPos} on each change. Parent of the Break/Place/
 * BreakAnimation panels.
 */
public class GuiBlockActionPanel<T extends InteractBlockAction> extends GuiActionPanel<T>
{
    ...
    public GuiBlockActionPanel(MinecraftClient mc, GuiRecordingEditorPanel panel)
    {
        super(mc, panel);
