...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormRateSection} (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormRateSection.java</p>
 */
public class GuiSnowstormRateSection extends GuiSnowstormModeSection<BedrockComponentRate>
{
    ...
    public GuiSnowstormRateSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
