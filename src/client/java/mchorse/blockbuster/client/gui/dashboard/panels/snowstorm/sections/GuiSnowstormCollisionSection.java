...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormCollisionSection} (roadmap
 * P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormCollisionSection.java</p>
 *
 * <p><b>Parity quirks:</b> {@code updateButtons} is deferred via a boolean flag
 * processed inside {@link #draw} (avoids mutating layout mid-callback);
 * {@link #getComponent} records {@code wasPresent} but never uses it — both
 * preserved.</p>
 */
public class GuiSnowstormCollisionSection extends GuiSnowstormComponentSection<BedrockComponentMotionCollision>
{
    ...
    public GuiSnowstormCollisionSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
