...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormAppearanceSection} (roadmap
 * P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormAppearanceSection.java</p>
 *
 * <p><b>Parity quirk (copy-paste bug):</b> the direction-mode y/z tooltips are
 * assigned to {@link #directionX}, leaving {@code directionY}/{@code directionZ}
 * untooltipped — preserved verbatim for GUI parity.</p>
 */
public class GuiSnowstormAppearanceSection extends GuiSnowstormComponentSection<BedrockComponentAppearanceBillboard>
{
    ...
    public GuiSnowstormAppearanceSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
