...
/**
 * Port of Blockbuster 2.7.2's {@code GuiSnowstormLifetimeSection} (roadmap P155).
 *
 * <p>Legacy source: blockbuster-1.12/src/main/java/mchorse/blockbuster/client/gui/dashboard/panels/snowstorm/sections/GuiSnowstormLifetimeSection.java</p>
 */
public class GuiSnowstormLifetimeSection extends GuiSnowstormModeSection<BedrockComponentLifetime>
{
    ...
    public GuiSnowstormLifetimeSection(MinecraftClient mc, GuiSnowstorm parent)
    {
        super(mc, parent);
