...
import mchorse.mclib.math.MathRandom;
...
public class Random extends NNFunction
{
    ...
    public double doubleValue()
    {
        ...
        {
            /* P156 determinism seam: defaults to Math.random(), overridable by a
             * seeded supplier for the deterministic particle-sim golden. */
            random = MathRandom.nextDouble();
        }
