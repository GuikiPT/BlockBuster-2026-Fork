...
/**
 * Port of McLib 2.4.3's {@code config/values/ValueColor.java} (roadmap P19):
 * float RGBA {@link Color} stored as a packed int, per-channel interpolation.
 */
public class ValueColor extends GenericValue<Color>
{
    ...
    public void valueFromNBT(NbtElement tag)
    {
        ...
        {
            this.set(new Color(((NbtInt) tag).intValue()));
        }
    }
    ...
    {
        return NbtInt.of(this.value.getRGBAColor());
    }
