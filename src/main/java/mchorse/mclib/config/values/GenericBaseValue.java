 ...
 *
 * <p>Port note (P19): NBTBase becomes yarn 1.20.4 {@link NbtElement}.</p>
 *
...
public abstract class GenericBaseValue<T> extends Value
{
     ...
     *         This is used in {@link #set(Object)}, for example, to avoid null values for primitive datatype wrappers.
     */
     ...
     */
    public abstract void valueFromNBT(NbtElement tag);

    /**
     * @return the value as instance of a subclass of {@link NbtElement}.
     *         It can also return null, depending on the implementation in the subclasses.
     */
    public abstract NbtElement valueToNBT();
