 ...
 *
 * Port of McLib 2.4.3's {@code Interpolations} (roadmap P9) — math verbatim;
 * 1.12.2 {@code MathHelper.wrapDegrees} maps 1:1 to yarn's
 * {@code net.minecraft.util.math.MathHelper.wrapDegrees}.
 *
 * @author mchorse
