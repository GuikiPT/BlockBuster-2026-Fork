...
/**
 * Port of McLib 2.4.3's {@code Interpolation} enum (roadmap P9). Math is copied
 * verbatim — constant names, ordinals and key strings are a serialization
 * contract (P12 keyframes store ordinals). {@code @SideOnly} markers dropped;
 * name/tooltip lookup lives in {@link IInterpolation} defaults.
 *
 * Legacy source: .tools/legacy-src/mclib/src/main/java/mchorse/mclib/utils/Interpolation.java
 */
