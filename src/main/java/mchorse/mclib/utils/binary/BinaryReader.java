...
/**
 * Full port of McLib 2.4.3's BinaryReader (roadmap P14) — little-endian
 * binary reading base for WAV (P18) and VOX (S5) parsing.
 *
 * Legacy source: .tools/legacy-src/mclib/src/main/java/mchorse/mclib/utils/binary/BinaryReader.java
 */
