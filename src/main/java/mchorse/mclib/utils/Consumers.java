...
/**
 * Full port of McLib 2.4.3's Consumers (roadmap P14). Backs the S2
 * confirm/answer framework. Note the identity-dedupe in {@link #register}:
 * registering the exact same consumer instance returns the existing id.
 *
 * Legacy source: .tools/legacy-src/mclib/src/main/java/mchorse/mclib/utils/Consumers.java
 */
