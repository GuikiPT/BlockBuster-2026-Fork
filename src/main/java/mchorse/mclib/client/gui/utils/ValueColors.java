...
/**
 * Port of McLib 2.4.3's {@code ValueColors} (roadmap P34) — the color
 * picker's favorite-colors list. Lives in the main source set (like the
 * {@code keys} package) because it is a pure config value: JSON format is an
 * int array of RGBA colors, wire format is count + ints appended to the base
 * {@link Value} framing — both are 1.12.2 contracts.
 */
