...
/**
 * Modifier (de)serializer (P170) — unknown/invalid {@code "type"} returns
 * null; callers ({@code ValueModifiers}) skip nulls, so unknown modifiers
 * are silently dropped, never a crash. Verbatim port.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/json/ModifierSerializer.java
 */
