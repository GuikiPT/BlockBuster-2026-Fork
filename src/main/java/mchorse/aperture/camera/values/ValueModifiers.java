...
/**
 * Verbatim P169 port — unknown modifier types deserialize to null and are
 * silently dropped (total reader); sub-values renamed to stringified
 * indices on {@link #sync()}. Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValueModifiers.java
 */
