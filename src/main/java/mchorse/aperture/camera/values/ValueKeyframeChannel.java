...
/**
 * Verbatim P169 port — accepts a plain keyframe array <b>or</b> the
 * {@code {keyframes:[...]}} object form on read; always sorts after load;
 * {@link #set} copies into the existing channel instance (identity is
 * shared with the owning fixture).
 * Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValueKeyframeChannel.java
 */
