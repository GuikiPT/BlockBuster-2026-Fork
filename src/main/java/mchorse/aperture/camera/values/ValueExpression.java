...
/**
 * Verbatim P169 port — serialized as the expression string (empty = null);
 * parse errors set {@link #lastError} and null the expression instead of
 * failing the load (total reader); ByteBuf = UTF8 string.
 * Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValueExpression.java
 */
public class ValueExpression extends Value
{
    ...
    public void fromBytes(ByteBuf buffer)
    {
        ...
        this.setValue(ForgeByteBufUtils.readUTF8String(buffer));
    }
    ...
    public void toBytes(ByteBuf buffer)
    {
        ...
        ForgeByteBufUtils.writeUTF8String(buffer, (String) this.getValue());
    }
