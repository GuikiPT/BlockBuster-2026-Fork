...
/**
 * Verbatim P169 port (including the legacy {@code super.fromBytes/toBytes}
 * asymmetry against {@link ValueAngle} — ValuePoint writes the Value header,
 * ValueAngle doesn't; both sides of the port agree so round-trips hold).
 * Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValuePoint.java
 */
