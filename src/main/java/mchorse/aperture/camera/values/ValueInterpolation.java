...
/**
 * Verbatim P169 port — JSON is the enum constant name
 * ({@code Interpolation.toString()}), ByteBuf is the ordinal.
 * Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValueInterpolation.java
 */
