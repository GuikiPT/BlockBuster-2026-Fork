...
/**
 * Verbatim P169 port — JSON object of curve id → keyframe array (non-array
 * entries skipped on load); ByteBuf = int count + UTF8 key + channel bytes.
 * {@code getValue()} keeps the legacy bug of iterating the freshly created
 * empty map (returns empty) — parity over sense.
 * Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValueCurves.java
 */
