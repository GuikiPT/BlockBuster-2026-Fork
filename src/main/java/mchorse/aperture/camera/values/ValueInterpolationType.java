...
/**
 * Verbatim P169 port — JSON is the lowercase {@code InterpolationType.name}
 * field, ByteBuf is the ordinal (never reorder the enum). Default HERMITE.
 * Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValueInterpolationType.java
 */
