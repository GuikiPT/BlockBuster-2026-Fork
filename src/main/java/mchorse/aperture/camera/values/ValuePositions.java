...
/**
 * Verbatim P169 port — sub-values renamed to stringified indices on
 * {@link #sync()} (index-based undo paths). Legacy source:
 * .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/values/ValuePositions.java
 */
