...
/**
 * Keyframe fixture (P173).
 *
 * Port notes: 8 channels registered as exactly
 * {@code "x","y","z","yaw","pitch","roll","fov","distance"} (JSON keys); an
 * <b>empty channel leaves that Position component untouched</b> (partial
 * keyframing); the {@code +0.05F} apply-side / {@code -0.05} capture-side
 * "zNear" epsilon pair must stay balanced.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/fixtures/KeyframeFixture.java
 */
