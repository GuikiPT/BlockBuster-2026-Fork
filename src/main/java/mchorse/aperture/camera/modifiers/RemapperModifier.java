...
/**
 * Remapper modifier (P176) — keyframe channel (default
 * {@code (0,0)→(Aperture.duration,1)}) <b>or</b> expression yields a 0..1
 * factor, multiplied by fixture duration, clamped; re-applies the fixture
 * with {@code partial = factor % 1} (sub-tick re-application for slow-mo
 * ramps); inert when {@code fixture == null} (global list). Verbatim.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/modifiers/RemapperModifier.java
 */
