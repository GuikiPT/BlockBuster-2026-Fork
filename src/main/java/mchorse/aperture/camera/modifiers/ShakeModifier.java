 ...
 * Shake modifier (P174).
 *
 * Port notes: when {@code active} is exactly yaw+pitch (bits 3+4 only) the
 * hidden "swing" formula applies ({@code sin²·cos·cos(x/2)},
 * {@code cos·sin²}); otherwise independent sin/cos offsets per component
 * (y <b>subtracts</b> sin). {@code shake == 0} → divisor 1. Verbatim.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/modifiers/ShakeModifier.java
 */
