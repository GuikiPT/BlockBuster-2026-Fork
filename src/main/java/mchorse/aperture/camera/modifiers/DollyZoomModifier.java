...
/**
 * Dolly zoom modifier (P176) — translation from the focus distance and the
 * ratio of {@code tan(fov/2)} at fixture start vs current, fov clamped min
 * 0.01; moves along the view direction; inert in the global list. Verbatim.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/modifiers/DollyZoomModifier.java
 */
