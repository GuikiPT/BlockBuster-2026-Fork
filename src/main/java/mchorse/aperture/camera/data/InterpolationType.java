...
/**
 * Port notes (P169): 22 constants in this exact declaration order — the
 * ordinal is a ByteBuf/network contract ({@code ValueInterpolationType}
 * writes {@code ordinal()}); the lowercase {@link #name} is the JSON
 * contract. {@code CUBIC}, {@code HERMITE} and {@code CIRCULAR} have no
 * {@code Interpolation} function (CIRCULAR cannot convert to keyframes).
 * Never reorder.
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/data/InterpolationType.java
 */
