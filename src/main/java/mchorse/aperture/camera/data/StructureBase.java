 ...
 * McLib's value API.
 *
 * Port notes (P169): verbatim port on the S1 {@code Value} tree. The
 * ByteBuf layout is the {@code register()} call order of every subclass —
 * an implicit wire contract; keep constructor registration order identical
 * to legacy. {@code getProperty} supports dotted paths (undo system, P185).
 *
 * Legacy source: .tools/legacy-src/aperture/src/main/java/mchorse/aperture/camera/data/StructureBase.java
 */
