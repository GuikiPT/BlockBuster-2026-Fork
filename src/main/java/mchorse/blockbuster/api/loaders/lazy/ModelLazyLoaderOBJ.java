...
/**
 * Lazy loader for OBJ based models.
 *
 * <p>Ported from Blockbuster 2.7.2. The bitmask ({@code json=1, obj=2, mtl=4},
 * shapes at {@code 1 << bit} from bit 3), the shapes-folder change detection
 * and the generated-model fallback are load-bearing and preserved verbatim.</p>
 */
